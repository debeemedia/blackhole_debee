...
const { createOrder, markDevivered, getAllOrdersByUser, getAnOrderByUser, getAllOrders } = require('../controllers/order.controller')
...
router.put(ROUTE_ORDER_DELIVERED, markDevivered)
